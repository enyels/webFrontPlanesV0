...
public class UsuarioTO  implements java.io.Serializable {
    ...
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.FacultadTO[] facultades;

    private java.lang.String login;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.RolTO[] roles;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOrigenTO sistemaOrigen;
    ...
    public UsuarioTO(
           ...
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.FacultadTO[] facultades,
           java.lang.String login,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.RolTO[] roles,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOrigenTO sistemaOrigen) {
     ...
     * @return facultades
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.FacultadTO[] getFacultades() {
        return facultades;
    }
     ...
     * @param facultades
     */
    public void setFacultades(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.FacultadTO[] facultades) {
        this.facultades = facultades;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.FacultadTO getFacultades(int i) {
        return this.facultades[i];
    }

    public void setFacultades(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.FacultadTO _value) {
     ...
     * @return roles
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.RolTO[] getRoles() {
        return roles;
    }
     ...
     * @param roles
     */
    public void setRoles(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.RolTO[] roles) {
        this.roles = roles;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.RolTO getRoles(int i) {
        return this.roles[i];
    }

    public void setRoles(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.RolTO _value) {
        this.roles[i] = _value;
    }
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOrigenTO getSistemaOrigen() {
        return sistemaOrigen;
    }
     ...
     * @param sistemaOrigen
     */
    public void setSistemaOrigen(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOrigenTO sistemaOrigen) {
        this.sistemaOrigen = sistemaOrigen;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "usuarioTO"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "facultadTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "rolTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
