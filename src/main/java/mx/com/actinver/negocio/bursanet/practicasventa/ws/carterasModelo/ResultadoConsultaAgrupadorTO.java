...
public class ResultadoConsultaAgrupadorTO  implements java.io.Serializable {
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO[] agrupadoresTO;
    ...
    public ResultadoConsultaAgrupadorTO(
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO[] agrupadoresTO,
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO[] getAgrupadoresTO() {
        return agrupadoresTO;
    }
     ...
     * @param agrupadoresTO
     */
    public void setAgrupadoresTO(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO[] agrupadoresTO) {
        this.agrupadoresTO = agrupadoresTO;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO getAgrupadoresTO(int i) {
        return this.agrupadoresTO[i];
    }

    public void setAgrupadoresTO(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "resultadoConsultaAgrupadorTO"));
