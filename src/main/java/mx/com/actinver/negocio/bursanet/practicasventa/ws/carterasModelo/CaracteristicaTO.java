...
public class CaracteristicaTO  extends mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.CatalogoTO  implements java.io.Serializable {
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.EstadoTO estadoTO;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.PosiblesValoresTO[] posiblesValores;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoCaracteristicaTO tipoCaracteristicaTO;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOperadorTO tipoOperadorTO;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.ValorTO[] valores;
    ...
    public CaracteristicaTO(
           ...
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.PosiblesValoresTO[] posiblesValores,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoCaracteristicaTO tipoCaracteristicaTO,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOperadorTO tipoOperadorTO,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.ValorTO[] valores) {
        super(
            descripcion,
            id,
            nombre);
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.PosiblesValoresTO[] getPosiblesValores() {
        return posiblesValores;
    }
     ...
     */
    public void setPosiblesValores(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.PosiblesValoresTO[] posiblesValores) {
        this.posiblesValores = posiblesValores;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.PosiblesValoresTO getPosiblesValores(int i) {
        return this.posiblesValores[i];
    }

    public void setPosiblesValores(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.PosiblesValoresTO _value) {
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoCaracteristicaTO getTipoCaracteristicaTO() {
        return tipoCaracteristicaTO;
    }
     ...
     */
    public void setTipoCaracteristicaTO(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoCaracteristicaTO tipoCaracteristicaTO) {
        this.tipoCaracteristicaTO = tipoCaracteristicaTO;
    }
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOperadorTO getTipoOperadorTO() {
        return tipoOperadorTO;
    }
     ...
     */
    public void setTipoOperadorTO(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOperadorTO tipoOperadorTO) {
        this.tipoOperadorTO = tipoOperadorTO;
    }
     ...
     * @return valores
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.ValorTO[] getValores() {
        return valores;
    }
     ...
     * @param valores
     */
    public void setValores(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.ValorTO[] valores) {
        this.valores = valores;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.ValorTO getValores(int i) {
        return this.valores[i];
    }

    public void setValores(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.ValorTO _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "caracteristicaTO"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "posiblesValoresTO"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "tipoCaracteristicaTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "tipoOperadorTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "valorTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
