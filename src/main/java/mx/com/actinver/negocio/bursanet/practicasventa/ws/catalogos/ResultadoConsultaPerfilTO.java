...
public class ResultadoConsultaPerfilTO  implements java.io.Serializable {
    ...
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.PerfilTO getPerfilTO(int i) {
        return this.perfilTO[i];
    }

    public void setPerfilTO(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.PerfilTO _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://catalogos.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "resultadoConsultaPerfilTO"));
