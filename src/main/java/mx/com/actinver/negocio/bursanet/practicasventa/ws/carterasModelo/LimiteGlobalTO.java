...
public class LimiteGlobalTO  implements java.io.Serializable {
    ...
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO[] agrupadores;
    ...
    public LimiteGlobalTO(
           ...
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO[] agrupadores,
     ...
     * @return agrupadores
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO[] getAgrupadores() {
        return agrupadores;
    }
     ...
     * @param agrupadores
     */
    public void setAgrupadores(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO[] agrupadores) {
        this.agrupadores = agrupadores;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO getAgrupadores(int i) {
        return this.agrupadores[i];
    }

    public void setAgrupadores(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.AgrupadorTO _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "limiteGlobalTO"));
