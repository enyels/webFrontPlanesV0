...
public class SubGrupoTO  implements java.io.Serializable {
    ...
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.CaracteristicaTO[] caracteristicas;
    ...
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.TipoValorTO[] tiposValorTO;

    private java.lang.Boolean editable;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.LimiteTO[] limitePerfiles;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ProductoTO[] productos;
    ...
    public SubGrupoTO(
           ...
           mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.CaracteristicaTO[] caracteristicas,
           java.lang.String hashCaracteristicas,
           java.lang.Long id,
           java.lang.String nombre,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.TipoValorTO[] tiposValorTO,
           java.lang.Boolean editable,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.LimiteTO[] limitePerfiles,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ProductoTO[] productos) {
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.CaracteristicaTO[] getCaracteristicas() {
        return caracteristicas;
    }
     ...
     */
    public void setCaracteristicas(mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.CaracteristicaTO[] caracteristicas) {
        this.caracteristicas = caracteristicas;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.CaracteristicaTO getCaracteristicas(int i) {
        return this.caracteristicas[i];
    }

    public void setCaracteristicas(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.CaracteristicaTO _value) {
     ...
     * @return tiposValorTO
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.TipoValorTO[] getTiposValorTO() {
        return tiposValorTO;
    }
     ...
     * @param tiposValorTO
     */
    public void setTiposValorTO(mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.TipoValorTO[] tiposValorTO) {
        this.tiposValorTO = tiposValorTO;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.TipoValorTO getTiposValorTO(int i) {
        return this.tiposValorTO[i];
    }

    public void setTiposValorTO(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.TipoValorTO _value) {
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.LimiteTO[] getLimitePerfiles() {
        return limitePerfiles;
    }
     ...
     */
    public void setLimitePerfiles(mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.LimiteTO[] limitePerfiles) {
        this.limitePerfiles = limitePerfiles;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.LimiteTO getLimitePerfiles(int i) {
        return this.limitePerfiles[i];
    }

    public void setLimitePerfiles(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.LimiteTO _value) {
     ...
     * @return productos
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ProductoTO[] getProductos() {
        return productos;
    }
     ...
     * @param productos
     */
    public void setProductos(mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ProductoTO[] productos) {
        this.productos = productos;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ProductoTO getProductos(int i) {
        return this.productos[i];
    }

    public void setProductos(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ProductoTO _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://catalogos.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "subGrupoTO"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://catalogos.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "caracteristicaTO"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://catalogos.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "limiteTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
