...
public class CorreoElectronicoTO  implements java.io.Serializable {
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.RemitenteTO remitente;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO[] destinatarios;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO[] destinatariosCC;
    ...
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ArchivoTO[] archivosAdjuntos;
    ...
    public CorreoElectronicoTO(
           mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.RemitenteTO remitente,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO[] destinatarios,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO[] destinatariosCC,
           java.lang.String asunto,
           java.lang.String mensaje,
           java.lang.String tipoContenido,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ArchivoTO[] archivosAdjuntos,
     ...
     * @return remitente
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.RemitenteTO getRemitente() {
        return remitente;
    }
     ...
     * @param remitente
     */
    public void setRemitente(mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.RemitenteTO remitente) {
        this.remitente = remitente;
    }
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO[] getDestinatarios() {
        return destinatarios;
    }
     ...
     * @param destinatarios
     */
    public void setDestinatarios(mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO[] destinatarios) {
        this.destinatarios = destinatarios;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO getDestinatarios(int i) {
        return this.destinatarios[i];
    }

    public void setDestinatarios(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO _value) {
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO[] getDestinatariosCC() {
        return destinatariosCC;
    }
     ...
     */
    public void setDestinatariosCC(mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO[] destinatariosCC) {
        this.destinatariosCC = destinatariosCC;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO getDestinatariosCC(int i) {
        return this.destinatariosCC[i];
    }

    public void setDestinatariosCC(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.DestinatarioTO _value) {
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ArchivoTO[] getArchivosAdjuntos() {
        return archivosAdjuntos;
    }
     ...
     */
    public void setArchivosAdjuntos(mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ArchivoTO[] archivosAdjuntos) {
        this.archivosAdjuntos = archivosAdjuntos;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ArchivoTO getArchivosAdjuntos(int i) {
        return this.archivosAdjuntos[i];
    }

    public void setArchivosAdjuntos(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.catalogos.ArchivoTO _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://catalogos.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "correoElectronicoTO"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("remitente");
        elemField.setXmlName(new javax.xml.namespace.QName("", "remitente"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://catalogos.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "remitenteTO"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://catalogos.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "destinatarioTO"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://catalogos.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "archivoTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
