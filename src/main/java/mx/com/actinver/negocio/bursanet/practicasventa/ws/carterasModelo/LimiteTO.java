...
public class LimiteTO  implements java.io.Serializable {
    ...
    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.LimiteProductoTO[] limitesProducto;

    private mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOperacionTO tipoOperacionTO;
    ...
    public LimiteTO(
           ...
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.LimiteProductoTO[] limitesProducto,
           mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.TipoOperacionTO tipoOperacionTO) {
           this.id = id;
     ...
     */
    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.LimiteProductoTO[] getLimitesProducto() {
        return limitesProducto;
    }
     ...
     */
    public void setLimitesProducto(mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.LimiteProductoTO[] limitesProducto) {
        this.limitesProducto = limitesProducto;
    }

    public mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.LimiteProductoTO getLimitesProducto(int i) {
        return this.limitesProducto[i];
    }

    public void setLimitesProducto(int i, mx.com.actinver.negocio.bursanet.practicasventa.ws.carterasModelo.LimiteProductoTO _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "limiteTO"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "limiteProductoTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://carterasModelo.ws.practicasventa.bursanet.negocio.actinver.com.mx/", "tipoOperacionTO"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
